    ...
    <div className="flex h-10 shrink-0 items-center gap-2 border-b border-border bg-background px-3">
        ...
        <div className="relative flex w-64 items-center">
          ...
          <input
            ...
            spellCheck={false}
            className="h-7 w-full rounded-md border border-border bg-surface pl-7 pr-12 text-[12px] text-foreground placeholder:text-faint outline-none focus:border-border-hover focus:ring-1 focus:ring-accent/30"
          />
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <button
            ...
            onClick={s.refresh}
            title="Refresh"
            className="flex h-7 items-center gap-1.5 rounded-md border border-border bg-surface px-2 text-[11px] font-medium text-muted hover:border-border-hover hover:text-foreground"
          >
